        ...
        if (args[0] == username & args[1] == password) {
            ...
            // If program is executed with a number as the third argument
                ...
                // If a 2 is the third argument
                    ...
                    Character dGender = rs.getCharacter("gender");
                ...
                // If a 3 is the third argument
                    ...
                    ResultSet rs1 = stmt.executeQuery("SELECT admissionNum, SSN, admissionTime, totalPayment FROM hospitalAdmission WHERE admissionNum = " + adNum);
                    ...
                    ResultSet rs2 = stmt.executeQuery("SELECT roomNum, stayStart, stayEnd FROM stayedIn WHERE admissionNum = " + adNum);
                    ...
                    ResultSet rs3 = stmt.executeQuery("SELECT empID FROM examinedBy WHERE admissionNum = " + adNum);
                ...
                // If a 4 is the third argument
                    ...
                    Statement stmt = conn.createStatement();
                    ResultSet rs = stmt.executeUpdate("UPDATE hospitalAdmission SET totalPayment = " + totPay + " WHERE admissionNum = " + adNum);
